...
function mp5_SW!(dfields, fields, par, t) # j is the grid position
    #asumimos u unidimensional por ahora
    par_eq, h, N, N_Fields, Fx!, Speed_max, auxvectors = par
    F_Mm3, F_Mm2, F_Mm1, F_M, F_Mp1, F_Mp2, F_Mp3, F_Pm3, F_Pm2, F_Pm1, F_P, F_Pp1, F_Pp2, F_Pp3, F_LP, F_LM, F_RP, F_RM, H_m, H_p = auxvectors
    ...
    for idx in 1:N
        ...
        Fx!(F_Pm3, um3, par_eq, xi)
        Fx!(F_Pm2, um2, par_eq, xi)
        Fx!(F_Pm1, um1, par_eq, xi)
        Fx!(F_P, u, par_eq, xi)
        Fx!(F_Pp1, up1, par_eq, xi)
        Fx!(F_Pp2, up2, par_eq, xi)
        Fx!(F_Pp3, up3, par_eq, xi)
